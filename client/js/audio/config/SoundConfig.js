...
const SoundConfig = {
  ...
  weapon_fire_1: {
    ...
    variationPattern: "weapons/weapon_player_t1_{index}.mp3",
    baseVolume: 0.7,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  weapon_fire_2: {
    ...
    variationPattern: "weapons/weapon_player_t2_{index}.mp3",
    baseVolume: 0.7,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  weapon_fire_4: {
    ...
    variationPattern: "weapons/weapon_player_t4_{index}.mp3",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  weapon_fire_5: {
    ...
    variationPattern: "weapons/weapon_player_t5_{index}.mp3",
    baseVolume: 0.85,
    priority: 75,
    category: "sfx",
    variations: 5,
  ...
  npc_weapon_pirate: {
    ...
    variationPattern: "weapons/weapon_pirate_{index}.mp3",
    baseVolume: 0.6,
    priority: 50,
    category: "sfx",
    variations: 3,
  ...
  npc_weapon_scavenger: {
    ...
    variationPattern: "weapons/weapon_scavenger_{index}.mp3",
    baseVolume: 0.5,
    priority: 50,
    category: "sfx",
    variations: 3,
  ...
  npc_weapon_swarm: {
    ...
    variationPattern: "weapons/weapon_swarm_{index}.mp3",
    baseVolume: 0.55,
    priority: 50,
    category: "sfx",
    variations: 3,
  ...
  npc_weapon_void: {
    ...
    variationPattern: "weapons/weapon_void_{index}.mp3",
    baseVolume: 0.65,
    priority: 50,
    category: "sfx",
    variations: 3,
  ...
  npc_weapon_rogue: {
    ...
    variationPattern: "weapons/weapon_rogue_miner_{index}.mp3",
    baseVolume: 0.6,
    priority: 50,
    category: "sfx",
    variations: 3,
  ...
  hit_shield_1: {
    ...
    variationPattern: "impacts/hit_shield_t1_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_shield_2: {
    ...
    variationPattern: "impacts/hit_shield_t2_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_shield_3: {
    ...
    variationPattern: "impacts/hit_shield_t3_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_shield_4: {
    ...
    variationPattern: "impacts/hit_shield_t4_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_shield_5: {
    ...
    variationPattern: "impacts/hit_shield_t5_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_hull_1: {
    ...
    variationPattern: "impacts/hit_hull_t1_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_hull_2: {
    ...
    variationPattern: "impacts/hit_hull_t2_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_hull_3: {
    ...
    variationPattern: "impacts/hit_hull_t3_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_hull_4: {
    ...
    variationPattern: "impacts/hit_hull_t4_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  hit_hull_5: {
    ...
    variationPattern: "impacts/hit_hull_t5_{index}.wav",
    baseVolume: 0.8,
    priority: 75,
    category: "sfx",
    variations: 3,
  ...
  npc_despawn: {
    // NPCs phase out rather than explode; reuse the existing rift-close cue.
    file: "environment/void_rift_close.mp3",
    baseVolume: 0.45,
    priority: 25,
    category: "sfx",
